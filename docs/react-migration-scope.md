...
- API scaffold: `src/synth_platform/interfaces/api/app.py`, `src/synth_platform/interfaces/api/routes/generation.py`, and `src/synth_platform/interfaces/api/routes/artifacts.py` contain scaffold docstrings only; there is no implemented FastAPI app object or route surface.
...
- API scaffold: `src/synth_platform/interfaces/api/app.py:1`, `src/synth_platform/interfaces/api/routes/generation.py:1`, `src/synth_platform/interfaces/api/routes/artifacts.py:1`, `src/synth_platform/interfaces/api/routes/training.py:1`, `src/synth_platform/interfaces/api/routes/validation.py:1`, and `src/synth_platform/interfaces/api/routes/connections.py:1` are scaffold docstrings only.
