...
from synth_platform.engine.inference.schema.domain_capsule import AssetProvenance, VocabularyAsset
...
class AssetStore:
    ...
    def __init__(self, root_dir: Optional[str] = None):
        default_root = Path.home() / ".mvp" / "assets"
    ...
    def _ensure_writable_root(self, preferred_root: Path) -> Path:
        try:
            ...
            fallback_root = Path(tempfile.gettempdir()) / ".mvp" / "assets"
