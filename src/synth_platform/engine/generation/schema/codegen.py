...
class ScriptGenerator:
    ...
    without the MVP library installed.
    """
...
"""
        if include_db:
            base += "from synth_platform.engine.generation.schema.db import seed_database\n"
        return base
    ...
    def generate(
        ...
        # Header comment
        script_parts.append('"""')
        script_parts.append("Auto-generated synthetic data script by MVP")
