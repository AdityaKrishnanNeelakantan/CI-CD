"""
Database seeding utilities for MVP.
...
def seed_from_sqlalchemy_models(
    ...
    *,
    ...
    """
    from synth_platform.engine.inference.schema.introspect import schema_from_sqlalchemy
...
def _connect(db_url: str) -> Tuple[str, object]:
    ...
    if scheme in ("postgres", "postgresql"):
        try:
            ...
            raise ImportError("Postgres driver missing. Install psycopg to use Postgres URLs.") from exc
