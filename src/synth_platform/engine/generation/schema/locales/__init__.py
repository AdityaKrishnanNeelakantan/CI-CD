"""
Locale-aware data generation for MVP.
...
Usage::
    ...
    from synth_platform.engine.generation.schema.locales import detect_locale, get_locale_pack, LocaleRegistry
...
from synth_platform.engine.generation.schema.locales.packs import LOCALE_PACKS, LocalePack
from synth_platform.engine.generation.schema.locales.detector import detect_locale_from_story, LOCALE_ALIASES
