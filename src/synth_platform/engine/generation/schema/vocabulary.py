...
from synth_platform.engine.inference.schema.domain_capsule import AssetProvenance, DomainCapsule, VocabularyAsset
from synth_platform.engine.generation.schema.reference_data import detect_domain as detect_reference_domain
