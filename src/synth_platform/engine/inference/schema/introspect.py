"""
Schema introspection utilities for MVP.
...
def schema_from_db(
    ...
    *,
    ...
    from synth_platform.engine.generation.schema.db import _connect  # type: ignore
...
def schema_from_sqlalchemy(
    ...
    *,
    ...
    try:
        ...
        raise ImportError("SQLAlchemy is required. Install mvp[orm].") from exc
