...
from synth_platform.engine.validation.schema.validation import DataValidator, SchemaValidationError, ValidationReport, validate_data, validate_schema
...
class TestValidateSchema:
    ...
    def test_outcome_curve_unknown_time_column_raises(self):
        from synth_platform.engine.inference.schema.schema import OutcomeCurve
        schema = _minimal_schema(
...
class TestReferentialIntegrity:
    ...
    def test_detects_orphan_fks(self):
        ...
        from synth_platform.engine.inference.schema.schema import SchemaConfig, Table, Column, Relationship
...
class TestOutcomeCurveValidation:
    ...
    def test_detects_outcome_curve_mismatch(self):
        ...
        from synth_platform.engine.inference.schema.schema import Column, OutcomeCurve, SchemaConfig, Table
